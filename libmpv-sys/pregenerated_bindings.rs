...
extern "C" {
    #[doc = " @deprecated use mpv_destroy(), which has exactly the same semantics (the"]
    #[doc = " deprecation is a mere rename)"]
    #[doc = ""]
    ...
    #[doc = "  This left the player running. If you want to be sure that the"]
    #[doc = "  player is terminated, send a \"quit\" command, and wait until the"]
    #[doc = "  MPV_EVENT_SHUTDOWN event is received, or use mpv_terminate_destroy()."]
...
extern "C" {
    #[doc = " This does nothing since mpv 0.23.0 (API version 1.24). Below is the"]
    #[doc = " description of the old behavior."]
    #[doc = ""]
    #[doc = " Stop the playback thread. This means the core will stop doing anything, and"]
    #[doc = " only run and answer to client API requests. This is sometimes useful; for"]
    #[doc = " example, no new frame will be queued to the video output, so doing requests"]
    #[doc = " which have to wait on the video output can run instantly."]
    #[doc = ""]
    #[doc = " Suspension is reentrant and recursive for convenience. Any thread can call"]
    #[doc = " the suspend function multiple times, and the playback thread will remain"]
    #[doc = " suspended until the last thread resumes it. Note that during suspension, all"]
    #[doc = " clients still have concurrent access to the core, which is serialized through"]
    #[doc = " a single mutex."]
    #[doc = ""]
    #[doc = " Call mpv_resume() to resume the playback thread. You must call mpv_resume()"]
    #[doc = " for each mpv_suspend() call. Calling mpv_resume() more often than"]
    #[doc = " mpv_suspend() is not allowed."]
    #[doc = ""]
    #[doc = " Calling this on an uninitialized player (see mpv_create()) will deadlock."]
    #[doc = ""]
    #[doc = " @deprecated This function, as well as mpv_resume(), are deprecated, and"]
    #[doc = "             will stop doing anything soon. Their semantics were never"]
    #[doc = "             well-defined, and their usefulness is extremely limited. The"]
    #[doc = "             calls will remain stubs in order to keep ABI compatibility."]
...
extern "C" {
    ...
    #[doc = "       to set options might still be required (see below, and also section"]
    #[doc = "       \"Inconsistencies between options and properties\" on the manpage). Once"]
    #[doc = "       these are resolved, the option setting functions might be fully"]
    #[doc = "       deprecated."]
    #[doc = ""]
    #[doc = "       The following options still need to be set either _before_"]
    #[doc = "       mpv_initialize() with mpv_set_property() (or related functions), or"]
    #[doc = "       with mpv_set_option() (or related functions) at any time:"]
    #[doc = "              - options shadowed by deprecated properties:"]
    #[doc = "                - demuxer (property deprecated in 0.21.0)"]
    #[doc = "                - idle (property deprecated in 0.21.0)"]
    #[doc = "                - fps (property deprecated in 0.21.0)"]
    #[doc = "                - cache (property deprecated in 0.21.0)"]
    #[doc = "                - length (property deprecated in 0.10.0)"]
    #[doc = "                - audio-samplerate (property deprecated in 0.10.0)"]
    #[doc = "                - audio-channels (property deprecated in 0.10.0)"]
    #[doc = "                - audio-format (property deprecated in 0.10.0)"]
    #[doc = "              - deprecated options shadowed by properties:"]
    #[doc = "                - chapter (option deprecated in 0.21.0)"]
    #[doc = "                - playlist-pos (option deprecated in 0.21.0)"]
    #[doc = "       The deprecated properties were removed in mpv 0.23.0."]
    #[doc = ""]
...
#[doc = " The list of video/audio/subtitle tracks was changed. (E.g. a new track"]
#[doc = " was found. This doesn't necessarily indicate a track switch; for this,"]
#[doc = " MPV_EVENT_TRACK_SWITCHED is used.)"]
#[doc = ""]
#[doc = " @deprecated This is equivalent to using mpv_observe_property() on the"]
#[doc = "             \"track-list\" property. The event is redundant, and might"]
#[doc = "             be removed in the far future."]
pub const mpv_event_id_MPV_EVENT_TRACKS_CHANGED: mpv_event_id = 9;
#[doc = " A video/audio/subtitle track was switched on or off."]
#[doc = ""]
#[doc = " @deprecated This is equivalent to using mpv_observe_property() on the"]
#[doc = "             \"vid\", \"aid\", and \"sid\" properties. The event is redundant,"]
#[doc = "             and might be removed in the far future."]
...
#[doc = " Playback was paused. This indicates the user pause state."]
#[doc = ""]
#[doc = " The user pause state is the state the user requested (changed with the"]
#[doc = " \"pause\" property). There is an internal pause state too, which is entered"]
#[doc = " if e.g. the network is too slow (the \"core-idle\" property generally"]
#[doc = " indicates whether the core is playing or waiting)."]
#[doc = ""]
#[doc = " This event is sent whenever any pause states change, not only the user"]
#[doc = " state. You might get multiple events in a row while these states change"]
#[doc = " independently. But the event ID sent always indicates the user pause"]
#[doc = " state."]
#[doc = ""]
#[doc = " If you don't want to deal with this, use mpv_observe_property() on the"]
#[doc = " \"pause\" property and ignore MPV_EVENT_PAUSE/UNPAUSE. Likewise, the"]
#[doc = " \"core-idle\" property tells you whether video is actually playing or not."]
#[doc = ""]
#[doc = " @deprecated The event is redundant with mpv_observe_property() as"]
#[doc = "             mentioned above, and might be removed in the far future."]
pub const mpv_event_id_MPV_EVENT_PAUSE: mpv_event_id = 12;
#[doc = " Playback was unpaused. See MPV_EVENT_PAUSE for not so obvious details."]
#[doc = ""]
#[doc = " @deprecated The event is redundant with mpv_observe_property() as"]
#[doc = "             explained in the MPV_EVENT_PAUSE comments, and might be"]
#[doc = "             removed in the far future."]
...
#[doc = " @deprecated This was used internally with the internal \"script_dispatch\""]
#[doc = "             command to dispatch keyboard and mouse input for the OSC."]
#[doc = "             It was never useful in general and has been completely"]
#[doc = "             replaced with \"script-binding\"."]
#[doc = "             This event never happens anymore, and is included in this"]
#[doc = "             header only for compatibility."]
...
#[doc = " Happens when metadata (like file tags) is possibly updated. (It's left"]
#[doc = " unspecified whether this happens on file start or only when it changes"]
#[doc = " within a file.)"]
#[doc = ""]
#[doc = " @deprecated This is equivalent to using mpv_observe_property() on the"]
#[doc = "             \"metadata\" property. The event is redundant, and might"]
#[doc = "             be removed in the far future."]
...
#[doc = " Happens when the current chapter changes."]
#[doc = ""]
#[doc = " @deprecated This is equivalent to using mpv_observe_property() on the"]
#[doc = "             \"chapter\" property. The event is redundant, and might"]
#[doc = "             be removed in the far future."]
...
pub type mpv_end_file_reason = i32;
...
pub struct mpv_event_end_file {
    #[doc = " Corresponds to the values in enum mpv_end_file_reason (the \"int\" type"]
    #[doc = " will be replaced with mpv_end_file_reason on the next ABI bump)."]
    #[doc = ""]
...
#[doc = " @deprecated see MPV_EVENT_SCRIPT_INPUT_DISPATCH for remarks"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " For using mpv's OpenGL renderer on an external OpenGL context."]
#[doc = " mpv_get_sub_api(MPV_SUB_API_OPENGL_CB) returns mpv_opengl_cb_context*."]
#[doc = " This context can be used with mpv_opengl_cb_* functions."]
#[doc = " Will return NULL if unavailable (if OpenGL support was not compiled in)."]
#[doc = " See opengl_cb.h for details."]
#[doc = ""]
#[doc = " @deprecated use render.h"]
pub const mpv_sub_api_MPV_SUB_API_OPENGL_CB: mpv_sub_api = 1;
#[doc = " @deprecated use render.h"]
pub type mpv_sub_api = i32;
extern "C" {
    #[doc = " This is used for additional APIs that are not strictly part of the core API."]
    #[doc = " See the individual mpv_sub_api member values."]
    #[doc = ""]
    #[doc = " @deprecated use render.h"]
...
pub type mpv_render_param_type = i32;
...
pub type mpv_render_frame_info_flag = i32;
...
pub type mpv_render_update_flag = i32;
#[doc = " Flags returned by mpv_render_context_update(). Each value represents a bit"]
#[doc = " in the function's return value."]
...
pub struct mpv_opengl_init_params {
    ...
    #[doc = " This should not be used. It is deprecated and will be removed or ignored"]
    #[doc = " when the opengl_cb API is removed."]
...
fn bindgen_test_layout_mpv_opengl_init_params() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<mpv_opengl_init_params>())).extra_exts as *const _ as usize
        },
        16usize,
        concat!(
        "Offset of field: ",
